package com.prescription.memory.generate;
...
public class CodeGenerator {
    ...
    private static final String author  = "Yinjie";//作者
    private static final String dbUrl = "jdbc:mysql://localhost:3306/practice?useUnicode=true&characterEncoding=UTF-8&sessionVariables=time_zone='%2B8:00'";//数据库连接url
    ...
    private static final String basePackage = "com.prescription.memory";//项目包路径
    ...
    public static void main(String[] args) {
        ...
        focList.add(new FileOutConfig("templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projDir + genPos + "/resources/mybatis/mapper" + pc.getModuleName()
       ...
       //需要生成的表名,以，隔开
        strategy.setInclude("zyyj_student_exam".split(","));
